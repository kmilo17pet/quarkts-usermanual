...
In QuarkTS, a state-machine must be instantiated with an object of type \lstinline{qSM_t}\index{\lstinline{qSM_t}}. States are represented as instances of the \lstinline{qSM_State_t}\index{\lstinline{qSM_State_t}} object. Here, the state machines are constructed by composition.
...
A timeout specification is defined as an structure of type \lstinline{qSM_TimeoutStateDefinition_t}\index{\lstinline{qSM_TimeoutStateDefinition_t}} and should follow this layout:
