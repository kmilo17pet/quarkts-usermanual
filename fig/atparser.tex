\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,scale=1]
        \draw  [color=black  ,draw opacity=1 ][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ][dash pattern={on 4.5pt off 4.5pt}] (80,70) -- (460,70) -- (460,240) -- (80,240) -- cycle ;
